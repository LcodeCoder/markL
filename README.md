...
正式介绍站在 [`web/`](web/)，纯静态 HTML / CSS / JS：

- 本地打开：[`web/index.html`](web/index.html)
- 功能 / 说明 / 下载 / 关于分属独立页面
- 下载链到 GitHub Release 当前版本

仓库里还留着一份较早的介绍页 [`docs/index.html`](docs/index.html)。之后如果做 GitHub Pages，把站点源设为 `/web` 即可。
